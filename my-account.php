				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
					<div class="account-info">
						<div class="single-account-info">
							<ul>
								<li><a href="order_status.php"><i class="fa fa-list-ol"></i><span>Chi tiết và lịch sử
											đơn hàng</span> </a></li>
								<li><a href="information.php"><i class="fa fa-user"></i><span>Thông tin cá nhân</span>
									</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="home-link-menu">
						<ul>
							...
							<form class="btn-logout" method="post" action="">
								<?php
