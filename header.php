...
<head>
  ...
  <title><?= isset($pageTitle) ? $pageTitle : "LEVENTS - Chính Hãng Việt Nam" ?></title>
  ...
  <link href='http://fonts.googleapis.com/css?family=Roboto:400,700,400italic&subset=latin,latin-ext' rel='stylesheet'
    type='text/css'>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="header-left-menu">
            <div class="welcome-info">
              CHÀO MỪNG ĐẾN VỚI <span>LEVENTS</span>
            </div>
          </div>
        </div>
            ...
            <nav>
              <ul class="list-inline">
                ...
                if (isset($_SESSION['ten'])) {
                  ...
                  echo '<li style="font-size:17px">
                  <a href="my-account.php" id="userNameAccount">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <!-- LOGO START -->
          <div class="logo">
            <a href="index.php"><img src="img/Va_no_la.avif" alt="MVC logo" /></a>
          </div>
          <!-- LOGO END -->
            ...
            <form action="search-result.php" method="get" name="form-search" class="search-form-cat"
              ...
              <div class="search-product form-group">
                <input type="text" style="width:90%;" class="form-control search-form" name="nameSearch"
                  ...
                  value="<?php if (isset($_GET['nameSearch']))
                  ...
                  while ($resultCatTitle = $catTitle->fetch_assoc()) {
                    ...
                    <li>
                      <a href="shop-gird.php?maLoai=<?php echo $resultCatTitle['maLoai']; ?>">
                        <?php echo $resultCatTitle['tenLoai']; ?>
                      </a>
                    </li>
                    <?php
                  }
