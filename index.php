	...
	<div class="container">
		<div class="row">
			...
			<div class="main-slider-area">
				<img src="img/collection-animal-banner.webp" alt="Banner">
			</div>
										...
										<div class="item">
											<div class="single-product-item">
												<div class="product-image">
													<a
														href="single-product.php?maSanPham=<?php echo $resultProd['maSanPham']; ?>">
												...
												<div class="product-info">
													...
													<a
														href="single-product.php?maSanPham=<?php echo urlencode($resultProd['maSanPham']); ?>">
														<span style="text-transform: uppercase;">
															<?php echo $textSh = $fm->textShorten($resultProd['tenSanPham'], 40); ?>
														</span>
													</a>
													<div class="price-box">
