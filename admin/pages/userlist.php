    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <span class="textHeading">Danh sách quản trị viên
                    <a href="useradd.php"><button type="button" class="btn btn-success"
                            style="float: right; margin-top:-6px">Thêm quản trị viên</button></a>
                </span>
            </div>
