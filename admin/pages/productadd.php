                        ...
                        ?>   
                            <form  method="POST" enctype="multipart/form-data" name="formUser" onsubmit="return validationForm();"> <!--enctype để có thể thêm hình ảnh -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <input type="number" name="soLuongSanPham" value="1" class="inputAddProduct" required>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <input type="number" name="giaSanPham" placeholder="Nhập giá..." class="inputAddProduct" required>
                                    </td>
                                </tr>
