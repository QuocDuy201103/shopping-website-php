                        ...
                        <table class="table table-bordered" id="cart-summary">
                            ...
                            <tfoot>
                                ...
                                <tr class="cart-total-price">
                                    ...
                                    <td id="total_product" class="price-total" colspan="1">
                    ...
                    <div class="returne-continue-shop">
                        ...
                        <?php if (isset($_SESSION['soluong'])) {
                            if (isset($_SESSION['ten'])) {
                                $so = $_SESSION['soluong'];
                                if ($so > 0) {
                                    echo '<a  href="checkout-address.php" class="continueshoping"><input type="submit" class="procedtocheckout" style="color: white;" value="Tiến hành thanh toán" ></a>';
                                }
                            } else {
                                echo '<a  href="registration.php" class="continueshoping"><input type="submit" class="procedtocheckout" value="Tiến hành thanh toán" style="color: white;"></a>';
                            }
                        } else {
                            echo '<input type="submit" class="procedtocheckout" value="Tiến hành thanh toán" style="color: white;" onClick="alert(\'Chưa có sản phẩm trong giỏ hàng\')";>';
                        } ?>
                    </div>
